...
CREATE TABLE IF NOT EXISTS Queue (
    ...
    CHECK (priority_level BETWEEN 1 AND 5),        --   1 = highest, 5 = lowest
...
CREATE TABLE IF NOT EXISTS Emergency_Case (
    ...
    CHECK (severity_level BETWEEN 1 AND 5)            -- 1 = Critical, 5 = Low
);
---inserting demo value
...
VALUES
        ('Diribsa Melka', 'M', '2000-04-23', '9887666', 'gerji Addis Abeba', 'AB'),
...
INSERT INTO Appointment (appointment_date, appointment_time, status, patient_id, doctor_id) VALUES
        ('2023-11-01', ' 09:00:00', 'Completed', 5, 2),
        ('2023-11-01', ' 10:30:00', 'Completed', 12, 5),
        ('2023-11-02', ' 14:00:00', 'Scheduled', 1, 8),
        ('2023-11-02', ' 15:30:00', 'Cancelled', 18, 1),
        ('2023-11-03', ' 08:45:00', 'Scheduled', 7, 10),
        ('2023-11-03', ' 11:00:00', 'Scheduled', 3, 3),
        ('2023-11-04', ' 09:30:00', 'Scheduled', 15, 7),
        ('2023-11-04', ' 16:00:00', 'Scheduled', 9, 4),
        ('2023-11-05', ' 10:00:00', 'Scheduled', 20, 6),
        ('2023-11-05', ' 13:30:00', 'Cancelled', 2, 9),
        ('2023-11-06', ' 09:00:00', 'Scheduled', 11, 2),
        ('2023-11-06', ' 11:30:00', 'Scheduled', 6, 5);
...
INSERT INTO Queue (appointment_id, queue_number, priority_level, estimated_time)
VALUES
    (3,  101, 2, 25),     
    (6,  102, 1, 15),    
    (7,  103, 3, 40),     
    ...
    INSERT INTO Emergency_Case (patient_id, severity_level, arrival_time, notes)
VALUES
    (4,  1, '2026-05-22 07:15:00', 'Severe chest pain, suspected heart attack'),
    (8,  2, '2026-05-22 08:05:00', 'High fever with convulsions - child'),
    (14, 1, '2026-05-22 08:40:00', 'Road traffic accident - multiple fractures'),
    (17, 3, '2026-05-22 09:10:00', 'Asthma attack, difficulty breathing'),
    (2,  4, '2026-05-22 09:45:00', 'Mild food poisoning');
...
--- Financial report: The following SQL query aggregates total payments received for each payment method.
This provides a summary of revenue generated through each payment channel and is useful for financial reporting and analysis. ---
